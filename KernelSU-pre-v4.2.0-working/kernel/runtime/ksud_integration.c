...
#if defined(__aarch64__) && LINUX_VERSION_CODE < KERNEL_VERSION(4, 16, 0)
static long (*orig_sys_read)(unsigned long fd, unsigned long buf,
                             unsigned long count, unsigned long arg4,
                             unsigned long arg5, unsigned long arg6);
static long ksu_sys_read(unsigned long fd, unsigned long buf, unsigned long count,
                         unsigned long arg4, unsigned long arg5,
                         unsigned long arg6)
{
    char __user *buf_user = (char __user *)buf;
    char __user **buf_ptr = &buf_user;
...
static long (*orig_sys_fstat)(unsigned long fd, unsigned long statbuf,
                              ...
                              unsigned long arg5, unsigned long arg6);
static long ksu_sys_fstat(unsigned long fd, unsigned long statbuf,
                          unsigned long arg3, unsigned long arg4,
                          unsigned long arg5, unsigned long arg6)
{
    long ret;
