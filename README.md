...
> HEAD（994e30004「336精修」之后仅删除过日志）即实测可开机的 4.14.336 状态。
...
994e30004  336精修：18个冲突文件三方解析 + cred/events 手工适配   ← 当前 HEAD 源状态
```
...
- kernel.org 4.14.y 已于 4.14.336（2024-01）EOL；OpenELA 的 linux-4.14.y 扩展维护至
  2024-12 也已结束，无后续官方补丁。
