...
/* BPF_F_RDONLY_PROG/BPF_F_WRONLY_PROG: eBPF program side read/write
 * access (upstream 5.2, commit a6ed3ea65ab98c2bd270dcb318ea2dcb5a).
 * netbpfload (Android 15) uses these for DEFINE_BPF_MAP_RO maps.
 */
